              ...
              <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div className="footer-widget">
                  ...
                  <p className="pra-clr mb-xxl-7 mb-6" data-aos="zoom-in" data-aos-duration={1600}>
                    Greetings! I'm Reezky (Muhammad Rizki), a proficient web and application developer with a diverse
                    skill set. My expertise spans a range of programming languages and technologies, allowing me to
                    craft dynamic and engaging digital solutions.
                  </p>
                  <ul className="common-social d-flex align-items-center gap-2">
                    <li data-aos="zoom-in-right" data-aos-duration={1600}>
                      <a href="https://github.com/itsreezky" className="d-center">
                        <i className="fa-brands fa-github fa-lg"></i>
                      </a>
                    </li>
                    <li data-aos="zoom-in-right" data-aos-duration={1800}>
                      <a href="https://linkedin.com/itsreezky" className="d-center">
                        <i className="fa-brands fa-linkedin fa-lg"></i>
                      </a>
                    </li>
                    <li data-aos="zoom-in-right" data-aos-duration={1900}>
                      <a href="https://instagram.com/reezky.0x00" className="d-center">
                        <i className="fa-brands fa-instagram fa-lg"></i>
                      </a>
                    </li>
                    <li data-aos="zoom-in-right" data-aos-duration={2100}>
                      <a href="https://x.com/itscoldhuman" className="d-center">
                        <i className="fa-brands fa-twitter fa-lg"></i>
                      </a>
                    </li>
                    <li data-aos="zoom-in-right" data-aos-duration={2200}>
                      <a href="http://itsreezky.my.id" className="d-center">
                        <i className="fa-solid fa-earth fa-lg"></i>
                      </a>
                    </li>
                  </ul>
                </div>
