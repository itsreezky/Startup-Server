        ...
        <div className="row g-xl-7 g-4 mb-xxl-7 mb-6 justify-content-center">
            ...
            <div className="contact-sub-info bg1-clr text-center">
              <center>
                <svg width={54} height={54} viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  />
                  <path
                    d="M37.5742 16.4252L46.4242 7.5752"
                    stroke="#E3FF04"
                    strokeWidth={4}
                    strokeLinecap="round"
                  ...
                  />
                  <path
                    d="M46.4242 16.4252L37.5742 7.5752"
                    stroke="#E3FF04"
                    strokeWidth={4}
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <h5 className="white mt-xxl-7 mt-6 mb-xxl-7 mb-6">Phone</h5>
              <span className="msub d-block mb-2">Mobile : +62 897-9174-555</span>
            </div>
          </div>
          <div className="col-lg-3 col-md-6 col-sm-6" data-aos="zoom-in-right" data-aos-duration={1600}>
            <div className="contact-sub-info bg1-clr text-center">
              ...
              <span className="msub d-block mb-2">
                <b className="text-pink-400">(About Server)</b> <br /> hello@itsreezky.my.id
              </span>
              <span className="msub">
                <b className="text-pink-400">(Bussiness)</b> <br /> muhammadrizkirmdhn26@gmail.com
              </span>
            </div>
          </div>
          <div className="col-lg-3 col-md-6 col-sm-6" data-aos="zoom-in-right" data-aos-duration={1800}>
            <div className="contact-sub-info bg1-clr text-center">
              ...
              <h5 className="white mt-xxl-7 mt-6 mb-xxl-7 mb-6">Location</h5>
              <span className="msub d-block mb-2">Perum Bumi Tamansari Permai</span>
              <span className="msub">Tasikmalaya, Jawa Barat, Indonesia.</span>
            </div>
          </div>
          <div className="col-lg-3 col-md-6 col-sm-6" data-aos="zoom-in-right" data-aos-duration={2000}>
            <div className="contact-sub-info bg1-clr text-center">
              ...
              <span className="msub d-block mb-2">Sun - Thu 08 am - 10pm</span>
              <span className="msub">Fri - Sat 7 pm - 12pm</span>
            </div>
          </div>
        </div>
          ...
          <div className="col-lg-6" data-aos="zoom-in" data-aos-duration={2000}>
            <div className="contact-map">
              <iframe
                ...
                marginheight="0"
                marginwidth="0"
                src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Perum%20Bumi%20Tamansari%20Permai+(Reezky's%20Server)&amp;t=k&amp;z=18&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
              ></iframe>
            </div>
          </div>
          <div className="col-lg-6" data-aos="zoom-in" data-aos-duration={2000}>
            <div className="contact-content bg1-clr">
              ...
              <form action="mailto:muhammadrizkirmdhn26@gmail.com">
                <div className="row g-xxl-8 g-xl-6 g-lg-4 g-4">
                  ...
                  <div className="col-lg-12">
                    <textarea name="messages" rows={5} placeholder="Message" defaultValue={''} />
                  </div>
                  <div className="col-lg-5">
                    <a href="mailto:muhammadrizkirmdhn26@gmail.com">
