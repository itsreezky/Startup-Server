            ...
            <div className="col-lg-6">
              <div className="about-content-v3">
                <div className="pricing-title">
                  <div
                    className="radius-btn cmn-border d-inline-flex radius100 py-xxl-2 py-2 px-xxl-4 px-4 gap-xxl-4 gap-3 mb-xxl-7 mb-xl-6 mb-5"
                  ...
                  <h3 className="stitle mb-xxl-8 mb-xl-7 mb-xl-5 mb-4" data-aos="fade-up" data-aos-duration={2000}>
                    ...
                    <span className="regular">powerful tech stack comprising.</span>
                  </h3>
                  <div data-aos="fade-in" data-aos-duration={2000}>
                    <p className="text-lg text-white mb-6">
                      Dynamic web application that embodies innovation and versatility. Leveraging a powerful tech stack
                      using
                      <b className="text-blue-400"> React.js</b>,<b className="text-red-500"> Laravel</b>,
                      <b className="text-green-500"> Vite</b>,<b className="text-teal-500"> Tailwind CSS</b>,
                      <b className="text-yellow-400"> DaisyUI</b>,<b className="text-purple-500"> Bootstrap</b>, and
                      <b className="text-blue-500"> Font Awesome</b>, this project delivers cutting-edge solutions
                      across frontend, backend, and design components.
                    </p>
                    <p className="text-lg text-white mb-6">Our platform showcases a diverse range of features:</p>
                  ...
                  <div className="global-counting mb-xxl-10 mb-xl-8 mb-6 d-flex align-items-center gap-xxl-7 gap-xl-5 gap-4">
                    <div className="counting-item">
                      ...
                      <span className="pra-clr">years of experience</span>
                    </div>
                    <div className="counting-item">
                      <h6>
                    ...
                    <div className="counting-item">
                      ...
                      <span className="pra-clr">certificates and awards</span>
                    </div>
                  </div>
                </div>
              </div>
