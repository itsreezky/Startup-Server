var VanillaTilt = (function () {
  ...
  class t {
    ...
    getValues() {
      ...
      return (
        this.fullPageListening
          ? ((t = this.event.clientX / this.clientWidth), (e = this.event.clientY / this.clientHeight))
          : ((t = (this.event.clientX - this.left) / this.width), (e = (this.event.clientY - this.top) / this.height)),
  ...
  return (
    'undefined' != typeof document && ((window.VanillaTilt = t), t.init(document.querySelectorAll('[data-tilt]'))), t
  );
})();
